...
\newcommand{\refa}[1]{\textbf{付録\ref{#1}}} % 付録参照のショートカット
\newcommand{\refs}[1]{\textbf{節\ref{#1}}} % 節参照のショートカット
\newcommand{\refss}[1]{\textbf{小節\ref{#1}}} % 小節参照のショートカット
\newcommand{\refsss}[1]{\textbf{項\ref{#1}}} % 項参照のショートカット
\newcommand{\refsssp}[1]{\textbf{段落\ref{#1}}} % 目参照のショートカット
