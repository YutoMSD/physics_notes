...
\begin{document}
  \section{イオン化エネルギー}
    ...
    \end{align}
    $n = 1$のときの軌道半径をBohr半径\index{ぼーあ半径@Bohr半径}と言い，$5.3 \times 10^{-11}\ \r{m}$である．
    各軌道に対する電子の全エネルギーは，
    \begin{align}
  ...
  \section{解離過程}
    では，どのようにして電離に必要なエネルギーを与えるのだろうか．主に，電子による\textbf{衝突電離}\index{しょうとつでんり@衝突電離}と\textbf{光電離}\index{ひかりでんり@光電離}がある．
    \subsection{衝突電離}
